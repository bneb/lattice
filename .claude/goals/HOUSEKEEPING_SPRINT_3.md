...
- [x] **H3-003:** Deep-read stmt.rs (3295→3292 lines) — cleaned: 1 eprintln!, 9 bracket labels. No major AI artifacts found (V25.8/CONSTITUTIONAL GUARD already cleaned)
- [x] **H3-004:** Deep-read mod.rs (2730→2693 lines) — cleaned: 12 eprintln!, 3 bracket labels, dead debug-only blocks. No COUNCIL tags found (already cleaned)
