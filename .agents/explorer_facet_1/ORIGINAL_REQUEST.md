...
You are explorer_facet_1.
Your working directory is: /Users/kevin/projects/lattice/.agents/explorer_facet_1
...
3. Perform a read-only scan of the following files/directories in /Users/kevin/projects/facet:
   - window/
   - gpu/
   - root directory files (Makefile, README.md, AGENTS.md, LICENSE, salt.toml, etc.)
   Verify and scan for:
